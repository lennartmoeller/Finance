...
type BaseTableRowProps = Omit<
    React.ComponentProps<typeof TableRow>,
    "children"
>;

interface TransactionsTableRowProps extends BaseTableRowProps {
...
const TransactionsTableRow = forwardRef<
    HTMLTableRowElement,
        ...
        return (
            <TableRow
                ...
                onFocus={(event) => {
                    onFocus?.(event);
                    if (transaction) {
                        setFocusedTransaction(transaction as Transaction);
                    }
                }}
                onBlur={(event) => {
                    onBlur?.(event);
...
TransactionsTableRow.displayName = "TransactionsTableRow";
